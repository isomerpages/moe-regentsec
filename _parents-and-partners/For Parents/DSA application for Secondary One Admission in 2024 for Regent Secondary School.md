...
| **Applied Learning Programme - Resource Sustainability (Interdisciplinary Category)** | The applicant must satisfy any one of the following:<br><br>• Actively involved with Robotics Club / Programming related CCA<br>• Has basic block programming background. (E.g. Microbits)<br>• Represented school in any programming related competitions. |
